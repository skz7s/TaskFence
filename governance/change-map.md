...
| security model, vulnerability boundary, compatibility policy, MSRV, semver, release supply-chain policy, or package publication expectations | `docs/security-model.md`, `docs/versioning.md`, `docs/supply-chain.md`, `docs/release.md`, `docs/maintainers.md`, `docs/decisions/` | `README.md`, `SECURITY.md`, `CONTRIBUTING.md`, `CHANGELOG.md`, `docs/config/readiness-checklist.md` |
