...
| repository visibility, public publication readiness, public GitHub settings, or open-source publication boundary | `docs/publication-readiness.md`, `docs/release.md`, `docs/config/readiness-checklist.md`, `docs/maintainers.md`, `docs/decisions/` | `README.md`, `docs/README.md`, `CHANGELOG.md` |
