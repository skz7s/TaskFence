...
- `.github/`: CODEOWNERS review routing, pull request template,
  bug/feature/documentation/support issue templates, Dependabot config, and CI
  workflows for the public repository.
